...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
    <p>
    Name   : Tom Holton<br>
    Details: Submitted the bid<br>
    Score  : </p>
   

    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Click here to enter Score</button>
    <a class="btn btn-link" href="bidderEvaluate.php" role="button">Cancel</a>
  </div>
